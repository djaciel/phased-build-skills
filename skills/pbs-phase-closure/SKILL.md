...
description: "Use after PR hardening is complete, to sync knowledge across global documents and prepare the next phase"
---
...
- `.pbs-framework/phases/phase-XX/review-report.md` — review findings and resolutions
- `.pbs-framework/phases/phase-XX/pr-description.md` — PR description (already generated by hardening)
...
3. `.pbs-framework/phases/phase-XX/review-report.md` — review findings and resolutions
4. `.pbs-framework/phases/phase-XX/pr-description.md` — PR description
5. Run `git log` for the phase's commits — what actually changed
...
- **Review Report:** `.pbs-framework/phases/phase-XX/review-report.md` — [status: resolved/clean]
- **PR Description:** `.pbs-framework/phases/phase-XX/pr-description.md`
...
- Spec compliance and code quality are NOT validated here — that was done by pbs-pr-hardening. Closure focuses on knowledge sync.
